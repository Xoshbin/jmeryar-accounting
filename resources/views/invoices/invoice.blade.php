    ...
    <div class="py-4">
                                ...
                                <tr>
                                    <td class="border-r pr-4">
                                        <div>
                                            ...
                                            <p class="whitespace-nowrap font-bold text-main text-right">{{ $record->invoice_date }}</p>
                                        </div>
                                    </td>
                                    <td class="pl-4">
                                        <div>
                                            <p class="whitespace-nowrap text-slate-400 text-right">Invoice #</p>
                                            <p class="whitespace-nowrap font-bold text-main text-right">{{ $record->invoice_number }}</p>
                                        </div>
                                    </td>
                                </tr>
                                </tbody>
                    ...
                    <td class="w-1/2 align-top">
                        <div class="text-sm text-neutral-600">
                            <div class="invoice-info">
                                ...
                                <p><strong>Issue Date:</strong> {{ $record->invoice_date }}</p>
                                <p><strong>Due Date:</strong> {{ $record->due_date }}</p>
                                <p><strong>Amount Due:</strong> {{ $record->amount_due }}</p>
                            </div>
                        </div>
                    </td>
        ...
        <div class="px-14 py-10 text-sm text-neutral-700">
            <table class="w-full border-collapse border-spacing-0">
                ...
                <tr>
                    <td class="border-b py-3 pl-3">{{ $item->product->name }}</td>
                    <td class="border-b py-3 pl-3 text-right">{{ $item->unit_price }}</td>
                    <td class="border-b py-3 pl-3 text-right">{{ $item->quantity }}</td>
                    <td class="border-b py-3 pl-3 text-right">{{ $item->unit_price * $item->quantity}}</td>
                </tr>
                @endforeach
                <tr>
                    <td colspan="7">
                                    ...
                                    <table class="w-full border-collapse border-spacing-0">
                                        ...
                                        <tr>
                                            ...
                                            <td class="bg-main p-3 text-right">
                                                <div class="whitespace-nowrap font-bold text-white">${{ $record->total_amount }}</div>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
