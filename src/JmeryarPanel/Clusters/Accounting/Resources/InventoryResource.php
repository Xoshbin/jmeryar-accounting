...
class InventoryResource extends Resource
{
    ...
    {
        return __('jmeryar-accounting::inventory.singular');
    }
    ...
    {
        return [
            'index' => Accounting\Resources\InventoryResource\Pages\ListInventories::route('/'),
            'create' => Accounting\Resources\InventoryResource\Pages\CreateInventory::route('/create'),
            'edit' => Accounting\Resources\InventoryResource\Pages\EditInventory::route('/{record}/edit'),
        ];
    }
}
