...
class InvoiceResource extends Resource
{
    ...
    {
        return __('jmeryar-accounting::invoices.singular');
    }
    ...
    {
        return [
            'index' => Accounting\Resources\InvoiceResource\Pages\ListInvoices::route('/'),
            'create' => Accounting\Resources\InvoiceResource\Pages\CreateInvoice::route('/create'),
            'edit' => Accounting\Resources\InvoiceResource\Pages\EditInvoice::route('/{record}/edit'),
        ];
    }
}
