...
class BillResource extends Resource
{
    ...
    {
        return __('jmeryar-accounting::bills.singular');
    }
    ...
    {
        return [
            'index' => Accounting\Resources\BillResource\Pages\ListBills::route('/'),
            'create' => Accounting\Resources\BillResource\Pages\CreateBill::route('/create'),
            'edit' => Accounting\Resources\BillResource\Pages\EditBill::route('/{record}/edit'),
        ];
    }
}
