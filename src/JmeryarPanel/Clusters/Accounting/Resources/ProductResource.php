...
class ProductResource extends Resource
{
    ...
    {
        return __('jmeryar-accounting::products.singular');
    }
    ...
    {
        return [
            Accounting\Resources\ProductResource\RelationManagers\InventoryBatchesRelationManager::class,
        ];
    }
    ...
    {
        return [
            'index' => Accounting\Resources\ProductResource\Pages\ListProducts::route('/'),
            'create' => Accounting\Resources\ProductResource\Pages\CreateProduct::route('/create'),
            'edit' => Accounting\Resources\ProductResource\Pages\EditProduct::route('/{record}/edit'),
        ];
    }
}
