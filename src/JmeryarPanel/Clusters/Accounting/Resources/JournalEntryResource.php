...
class JournalEntryResource extends Resource
{
    ...
    {
        return __('jmeryar-accounting::journal_entries.singular');
    }
    ...
    {
        return [
            'index' => Accounting\Resources\JournalEntryResource\Pages\ListJournalEntries::route('/'),
            'create' => Accounting\Resources\JournalEntryResource\Pages\CreateJournalEntry::route('/create'),
            'edit' => Accounting\Resources\JournalEntryResource\Pages\EditJournalEntry::route('/{record}/edit'),
        ];
    }
}
